...
1. Create or open the destination GitHub repository.
2. Choose **Add file → Upload files**.
3. Drag everything inside this directory onto the upload page, then commit the upload to the default branch.
4. Open **Settings → Pages**.
5. Under **Build and deployment**, choose **Deploy from a branch**.
6. Select the default branch (normally `main`) and the root (`/`) folder, then save.
